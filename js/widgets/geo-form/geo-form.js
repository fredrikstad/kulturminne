        ...
        _init: function () {
            ...
            BootstrapMap.createWebMap(this.webMapID, "gf-mapDiv", {
                ...
                this.locator = new Locator({
                  ...
                  "itemInfo": response.itemInfo.itemData,
                  "layerId": this.layerId,
                  "locatorContainer": this.geoformLocator,
                  "handleFeatureSearch": false
                });
                ...
                this.appUtils.createGeoLocationButton(this.config, response.itemInfo.itemData.baseMap.baseMapLayers, this.map, this.geoLocationButton, true);
